...
class Search extends AbstractApi
{
     ...
     */
    public function repositories($q, $sort = 'updated', $order = 'desc', $page = 1, $per_page = 30)
    {
        return $this->get('/search/repositories', ['q' => $q, 'sort' => $sort, 'order' => $order, 'page' => $page, 'per_page' => $per_page]);
    }
     ...
     */
    public function issues($q, $sort = 'updated', $order = 'desc', $page = 1, $per_page = 30)
    {
        return $this->get('/search/issues', ['q' => $q, 'sort' => $sort, 'order' => $order, 'page' => $page, 'per_page' => $per_page]);
    }
